...
import banquet2 from "../../public/banquet2.jpg";
import banquet3 from "../../public/banquet3.jpg";

function BanquetServicesBottomMiddle() {
  let iconStyles = { color: "white", fontSize: "2.5em" };

  return (
    <Panel
      shaded
      className="mb-5 divide-y  divide-blue-200  mt-5 md:w-3/5 h-2/3 sm:h-auto  m-auto">
        ...
        <div className="card-body bg-gray-800 rounded-xl bg-gradient-to-br from-[#6025F5] to-[#FF5555]  text-white transition duration-200 hover:shadow-lg hover:shadow-[#6025F5]/50">
          ...
          <p className="card-text text-center mt-3 ">
            <small className="text-muted  d-flex justify-center hover:bg-[#F2ECE7] font-medium tracking-wide text-center hover:text-[#000000dd] focus:outline-none focus:ring focus:ring-teal-300 focus:ring-opacity-80">
              Elevate your event management capabilities with our Banquet
              Management System, empowering you to efficiently handle bookings,
              scheduling, and logistics for seamless event execution.
            </small>
          </p>
        </div>
      </div>
...
export default BanquetServicesBottomMiddle;
